...
scoring_functions_gold = ['CONSRANK_val', 'CP_HLPL', 'CP_MJ3h', 'DDG_V', 'CP_RMFCA', 'AP_GOAP_DF', 'TF2', 'RFC']
scoring_functions_gold_RF = ['CONSRANK_val', 'CP_HLPL', 'CP_MJ3h', 'DDG_V', 'CP_RMFCA', 'AP_GOAP_DF', 'TF2', 'NNC']
...
#     x_train= x_train.drop(['label_binary','TF2','idx'],axis=1)
    ...
    x_val  = x_val[target_classifiers]
    x_val_bal  = x_val_bal[target_classifiers]
#     x_val = x_val.drop(['label_binary','TF2','idx'],axis=1)
    ...
    x_test = x_test[target_classifiers]
    x_test_bal = x_test_bal[target_classifiers]
#     x_test = x_test.drop(['label_binary','TF2','idx'],axis=1)
    ...
    for classifier in scoring_functions:
        if classifier != "RFC" or classifier != "NNC" or classifier != "TF2":
...
def read_data_gold_data() :
    ...
    ## Select the features for the sets 
    x_train= x_train[scoring_functions_gold] 
...
def read_data_gold_data_RF() :
    ...
    ## Select the features for the sets 
    x_train= x_train[scoring_functions_gold_RF] 
